...
As expected the usage of Cross validation allowed the training process to avoid over fitting. So the accuracy measurements obtained from the training, are not different from the ones obtained from testing *rTest*. This allows to have better predicting algorithm.
